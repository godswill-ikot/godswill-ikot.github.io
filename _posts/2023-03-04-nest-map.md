---
title: Presenting a basic sandboxed network with three (3) virtual machines
output:
  md_document:
...
- Make a sketch on packet-tracer:
  ...
  Draw a rough sketch of your network diagram using either a cisco newtwork packet-tracer, pen and paper, or gns3 on ubuntu. <img src="/images/posts/nest-map/packetracer.PNG" style="display: block; margin: auto;" />
...
- Desktop Configuration and set-up:
